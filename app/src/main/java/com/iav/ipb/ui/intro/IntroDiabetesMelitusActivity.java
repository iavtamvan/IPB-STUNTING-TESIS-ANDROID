...
public class IntroDiabetesMelitusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intro_diabetes_melitus);
        ...
        myViewPagerAdapter = new IntroDiabetesMelitusActivity.MyViewPagerAdapter();
