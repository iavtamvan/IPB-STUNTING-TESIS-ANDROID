...
public class IntroPreeklamsiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intro_preeklamsia);
        ...
        myViewPagerAdapter = new IntroPreeklamsiaActivity.MyViewPagerAdapter();
